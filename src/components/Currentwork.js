      ...
      <div className="container px-5 py-10 mx-auto text-center lg:px-40">
        <div className="flex flex-col w-full mb-20">
          ...
          <h1 className="sm:text-4xl text-3xl font-medium title-font mb-4 text-stone-300">
            ...
            <h1 className="grid grid-cols-2 gap-4 place-content-start h-8 sm:text-2xl text-3xl font-medium title-font mt-4 text-stone-300">Sayner Mobil</h1>
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-stone-300">
            ...
            <br></br>
            <h1 className="grid grid-cols-2 gap-4 place-content-start h-8 sm:text-2xl text-3xl font-medium title-font mt-4 text-stone-300">Job Tracker</h1>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-base text-stone-300"> 
