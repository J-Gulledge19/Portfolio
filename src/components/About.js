          ...
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-5 px-10">
            ...
            <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
              ...
              <div className="flex justify-center">
                <a href="https://www.linkedin.com/in/joshgulledge/" target='_blank' rel="noreferrer" class="relative inline-flex items-center mr-1 px-8 py-1 overflow-hidden text-lg font-medium text-stone-300 border-2 border-blue-600 rounded-full hover:text-white group hover:bg-gray-50 shadow-xl shadow-black">
                ...
                <a href="https://github.com/J-Gulledge19" target='_blank' rel="noreferrer" class="relative inline-flex items-center mr-1 px-8 py-1 overflow-hidden text-lg font-medium text-stone-300 border-2 border-blue-600 rounded-full hover:text-white group hover:bg-gray-50 shadow-xl shadow-black">
                <span class="absolute left-0 block w-full h-0 transition-all bg-blue-500 opacity-100 group-hover:h-full top-1/2 group-hover:top-0 duration-400 ease"></span>
                <span class="absolute right-0 flex items-center justify-start w-8 h-10 duration-300 transform translate-x-full group-hover:translate-x-0 ease">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                </span>
                ...
                <a href="https://docs.google.com/document/d/1Q2D7sv1Lea7w44XFhEabS5TpRDWhgKoIZ8oWKgwOBxw/edit?usp=sharing" target='_blank' rel="noreferrer" class="relative inline-flex items-center px-8 py-1 overflow-hidden text-lg font-medium text-stone-300 border-2 border-blue-600 rounded-full hover:text-white group hover:bg-gray-50 shadow-xl shadow-black">
                <span class="absolute left-0 block w-full h-0 transition-all bg-blue-500 opacity-100 group-hover:h-full top-1/2 group-hover:top-0 duration-400 ease"></span>
                <span class="absolute right-0 flex items-center justify-start w-8 h-10 duration-300 transform translate-x-full group-hover:translate-x-0 ease">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                </span>
